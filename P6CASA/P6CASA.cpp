...
void display(void)
{
	...
	//Electrón 2
	model = glm::rotate(model, glm::radians(electron), glm::vec3(0.0f, 2.0f, 0.0f)); 
	model = glm::translate(model, glm::vec3(-6,0 , 0));
	model = glm::rotate(model, glm::radians(electron), glm::vec3(0.0f, 1.0f, 0.0f)); 
	model = glm::scale(model, glm::vec3(0.4f, 0.4f, 0.4f));
	projectionShader.setMat4("model", model);
	...
	//Electron 3 Segunda vuelta 
	model = glm::rotate(model, glm::radians(electron), glm::vec3(1.0f, 0.f, 0.0f)); 
	model = glm::translate(model, glm::vec3(0, 0, 6));
	model = glm::rotate(model, glm::radians(electron), glm::vec3(1.0f, 1.0f, 0.0f)); 
	model = glm::scale(model, glm::vec3(0.4f, 0.4f, 0.4f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.8f, 0.3f, 0.5f));
	sphere_draw();
	model = glm::mat4(1.0f);

	//Electron 4 Segunda vuelta 
	model = glm::rotate(model, glm::radians(electron), glm::vec3(1.0f, 0.f, 0.0f));
	model = glm::translate(model, glm::vec3(0, 0, -6));
	model = glm::rotate(model, glm::radians(electron), glm::vec3(1.0f, 1.0f, 0.0f));
	model = glm::scale(model, glm::vec3(0.4f, 0.4f, 0.4f));
