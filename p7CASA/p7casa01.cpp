...
void display(void)
{
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", glm::vec3(1.0f, 0.0f, 1.0f));
	projectionShader.setVec3("diffuseColor", 0.8f, 0.8f, 0.0f);
	...
	model = glm::mat4(1.0f);
	model = glm::rotate(model = glm::mat4(1.0f), glm::radians(electron), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(3, 0, 0)); // translate
	model = glm::rotate(model, glm::radians(electron), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::scale(model, glm::vec3(0.20, 0.20, 0.20));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 0.0f, 0.0f, 0.0f);
	projectionShader.setVec3("diffuseColor", 0.0f, 0.8f, 0.8f);
	...
	model = glm::mat4(1.0f);
	model = glm::rotate(model = glm::mat4(1.0f), glm::radians(electron), glm::vec3(.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(6, 0, 0)); // translate
	model = glm::rotate(model, glm::radians(electron), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::scale(model, glm::vec3(0.20, 0.20, 0.20));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 0.0f, 0.0f, 0.0f);
	...
	model = glm::mat4(1.0f);
	model = glm::rotate(model = glm::mat4(1.0f), glm::radians(electron), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(9, 0, 0)); // translate
	model = glm::rotate(model, glm::radians(electron), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::scale(model, glm::vec3(0.20, 0.20, 0.20));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 0.0f, 0.0f, 0.0f);
	...
	// Electron 4
	model = glm::mat4(1.0f);
	model = glm::rotate(model = glm::mat4(1.0f), glm::radians(electron), glm::vec3(0., 0.5, 0.5));
	model = glm::translate(model, glm::vec3(-6, 0, 0));
	model = glm::rotate(model, glm::radians(electron), glm::vec3(0, 1, 0));
	model = glm::scale(model, glm::vec3(0.20, 0.20, 0.20));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 0.0f, 0.0f, 0.0f);
	projectionShader.setVec3("diffuseColor", 0.9f, 1.0f, 0.1f);
	projectionShader.setVec3("specularColor", 1.0f, 1.0f, 1.0f);
	my_sphere.render();
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 0.0f, 0.0f, 0.0f);
	projectionShader.setVec3("diffuseColor", 0.9f, 0.1f, 1.0f);
	projectionShader.setVec3("specularColor", 1.0f, 1.0f, 1.0f);
	my_sphere.render();
...
void my_input(GLFWwindow *window)
{
	...
	if (glfwGetKey(window, GLFW_KEY_P) == GLFW_PRESS)
		lightPos = glm::vec3(-10.0f, 10.0f, 0.0f);
