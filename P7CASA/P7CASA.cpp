...
void display(void)
{
	...
	model = glm::mat4(1.0f);
	model = glm::rotate(model = glm::mat4(1.0f), glm::radians(mercurio), glm::vec3(0.0f, 1.0f, 0.0f));
	...
	model = glm::mat4(1.0f);
	model = glm::rotate(model = glm::mat4(1.0f), glm::radians(mercurio), glm::vec3(.0f, 1.0f, 0.0f));
	...
	// Electron 4
	model = glm::mat4(1.0f);
	model = glm::rotate(model = glm::mat4(1.0f), glm::radians(mercurio), glm::vec3(0., 0.5, 0.5));
